    ...
    <div class="content-header">
      <div class="card card-into card card-outline card-header">
        ...
        <div class="row g-3 align-items-center">
          <div class="col-auto">
            <form method="post">
              <a href="/BarangKeluar/create" class="btn btn-primary btn-sm">
                <i class="fas fa-plus"> Tambah Data</i>
              </a>
            </form>
          </div>
          <div class="col-auto">
            <a href="/BarangKeluar/cetak" class="btn btn-success btn-sm" target="blank">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              <form action="/BarangKeluar/{{ $brgKeluar->id_keluar }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin Hapus Data?')">
                @method('delete')
                @csrf
